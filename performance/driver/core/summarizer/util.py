...
try:
  ...
  import logging
  logging.error('One or more libraries required by core.classes.summarizer.util'
...
def confidence_interval(timeseries:SummarizerAxisTimeseries, confidence=0.975):
  """
